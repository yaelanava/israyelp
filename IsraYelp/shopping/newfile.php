			...
			<?php 
				...
				if ($result_restReview) {						
					...
					$html = "<div id=\"top_biz\">
								...
								<p class=\"biz_info\">1. <a href=\"./shop.php?biz_id=$topRest_id\" id=\"top_biz_name_1\" style=\"FONT-WEIGHT: bold;\">".$topRestaurant['name']."</a></p>							
			...
			<ul id="biz_list" class="stripped">
				<?php
					...
					while ($rest = mysqli_fetch_assoc($result_shopping)){
						...
						$html .= "<li>
									<div class=\"biz_info\">
										$i. <a href=\"./shop.php?biz_id=".$rest_id."\" id=\"top_biz_name_$i\" class=\"biz_name\">".$rest['name']."</a>
									</div>
