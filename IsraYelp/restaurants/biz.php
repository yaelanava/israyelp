		...
		<tr>		
			<td style="vertical-align:top">
				...
				<br></br>			
					...
					<ul>							
						<li><strong>משלוחים: </strong><?php if($biz['delivery']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>כשר: </strong><?php if($biz['kosher']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>גישה לנכים: </strong> <?php if($biz['invalid_access']==1){echo  "כן";} else {echo "לא";} ?></li>
						<li><strong>ידידותי לילדים: </strong> <?php if($biz['child_friendly']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>אירועים: </strong> <?php if($biz['events']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>רומנטי: </strong> <?php if($biz['romantic']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>חניה: </strong> <?php if($biz['parking']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>אזור עישון: </strong> <?php if($biz['smoking']==1){echo "כן";} else {echo "לא";} ?></li>
						<li><strong>ישיבה בחוץ: </strong> <?php if($biz['outside']==1){echo "כן";} else {echo "לא";} ?></li>									
					</ul>
				</div>				
