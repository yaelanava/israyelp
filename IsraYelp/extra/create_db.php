...
INSERT INTO `beauty` 
(`id`, `name`, `another_name`, `address`, `city_id`, `lat`, `lon`, `phone_number`, `category`, `grading`, 

`num_reviews`, `hours`, `link`, `invalid_access`, `parking`, `events`) VALUES
(1, 'מרכז ציפה', 'Private Sea', 'קהילת סלוניקי 11, תל אביב', 1, 32.113591, 34.824404, '03-6488112', 'ספא', 0, 0, 'א\'- ה\' 09:00 - 21:00 ו\' 09:00 - 

15:00', 'www.privatesea.co.il', 'לא', 'כן', 'כן'),
(2, 'לייף לוקס', 'life luxe', 'נחלת יצחק 18, מגדלי תל אביב', 1, 32.074653, 34.797989, '1-700-700-606', 'ספא', 0, 0, 'יום א\' 17:00-21:00 יום ב\'-ה\' 9:00-

21:00 ימי ו\' ושבת: 9:00-18:00', 'www.lifeluxe.co.il', 'כן', 'כן', 'כן'),
(3, 'ספא מעל כולם', 'aboveall', 'אליעזר פרי 10, תל אביב', 1, 32.087071, 34.770266, '03-5201880', 'ספא', 0, 0, 'כל ימות השעות כולל שישי ושבת - 07:00-19:00', 

'www.aboveall.co.il', 'לא', 'כן', 'כן'),
(4, 'טיטניק ספא', 'Titanic Spa', 'לישינסקי 17, ראשון לציון', 2, 31.992468, 34.767047, '03-9416171', 'ספא', 0, 0, '9:00 - 21:00', 

'www.titanicspa.co.il', 'לא', 'כן', 'כן'),
(5, 'דודו רומנו', NULL, 'שמעון פרס 33 ראשון לציון', 2, 31.968443, 34.763871, '1-700-709705', 'עיצוב שיער', 0, 0, 'א\'-ה\' 9:00-21:00 ו\' 8:30-15:00', 

'www.dudu-romano.co.il', 'כן', 'כן', ''),
(6, 'ויציאנו שלומי - עיצוב שיער', NULL, 'שדרות החירות 17 , חדרה', 7, 32.440936, 34.915484, '04-6325444', 'עיצוב שיער,בניית ציפורניים', 0, 0, '09:00-19:30', 
...
INSERT INTO `hotels` (`id`, `name`, `another_name`, `address`, `city_id`, `lat`, `lon`, `phone_number`, 

`category`, `grading`, `num_reviews`, `link`, `invalid_access`, `parking`, `spa`, `pool`, `kosher`, `kids_club`, 

`intranet`, `tv`, `mini_bar`, `jim`) VALUES
(1, 'דן', 'Dan', 'הירקון 99 , תל אביב', 1, 32.079496, 34.767931, '03-5202525', 'מלונות', 0, 0, NULL, 'כן', 'כן', 'כן', 'כן', 'כן', 'כן', 'כן', 'כן', 'כן', 'לא'),
(2, 'גולדן ביץ\'', 'Golden Beach', 'הרברט סמואל 56 , תל אביב', 1, 32.07345, 34.764948, '057-9376958', 'מלונות', 0, 0, NULL, 'לא', 'לא', 'לא', 'לא', 'לא', 'לא', 'כן', 'כן', 'כן', 

'לא'),
(3, 'ישרוטל טאואר', 'ISROTEL Tower', 'הירקון 78 , תל אביב', 1, 32.076891, 34.767107, '03-5113603', 'מלונות', 0, 0, NULL, 'כן', 'כן', 'לא', 'כן', 'לא', 'לא', 'לא', 'לא', 'לא', 
...
INSERT INTO `nightlife` (`id`, `name`, `another_name`, `address`, `city_id`, `lat`, `lon`, `phone_number`, 

`category`, `grading`, `num_reviews`, `hours`, `link`, `invalid_access`, `Happy Hour`, `parking`, `outside`, 

`smoking`) VALUES
(1, 'שבלול jazz', 'Sablul Jazz', 'האנגר 13 - נמל תל-אביב, תל אביב', 1, 32.098629, 34.774257, '03-5461891', 'ג\'אז ובלוז', 0, 0, '20:00-02:00', 

'www.shabluljazz.com', 'כן', 'לא', 'כן', 'לא', 'לא'),
(2, 'מועדון הבלוק', 'The Block Club', 'דוד חכמי 35, תל-אביב', 1, 32.063436, 34.783764, '03-5379963', 'מועדוני דאנס', 0, 0, '', 'www.block-club.com', 
...
INSERT INTO `restaurants` (`id`, `name`, `another_name`, `address`, `city_id`, `lat`, `lon`, `phone_number`, 

`category`, `grading`, `num_reviews`, `link`, `delivery`, `invalid_access`, `events`, `parking`, `outside`, 

`kosher`, `child_friendly`, `romantic`, `smoking`) VALUES
...
(2, 'Niho','ניהו' ,'משה בקר 9 - א.ת. ישן, ראשון לציון', 2, 31.974337, 34.80871, '057-222-3333  (שלוחה 4222)', 'ארועים,בשר,דגים', 0, 0, NULL, 'לא', 'כן', 'כן', 'כן', 'כן', 

'לא', 'כן', 'כן', 'כן'),
(3, 'קפה נמרוד', 'cafe Nimrod', 'האנגר 8 - נמל תל אביב, תל אביב', 1, 32.098034, 34.774446, '077-2133007', 'ארועים', 0, 0, NULL, 'לא', 'כן', 'כן', 'כן', 'כן', 'לא', 'כן', 'כן', 

'כן'),
(4, 'פאשה', 'Pasha', 'הארבעה 8, תל אביב', 1, 32.070416, 34.783591, '03-5617778', 'ארועים,בשר,ים-תיכוני', 0, 0, NULL, 'לא', 'כן', 'כן', 'כן', 'לא', 'כן', 'לא', 'כן', 'לא'),
(6, 'Black Bar ''n'' Burger', 'בלק','הברזל 23 - רמת החייל , תל אביב', 1, 32.108993, 34.839746, '03-6441000', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'כן', 'כן', 

'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(7, 'Black Bar ''n'' Burger', 'בלק', 'קניון עזריאלי קומה 1, תל אביב', 1, 32.074226, 34.790897, '03-6950060', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'כן', 'כן', 

'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(8, 'Black Bar ''n'' Burger', 'בלק', 'נפחא 52, מתחם one plaza, באר שבע', 5, 31.249344, 34.811348, '1-599-555550', 'ארועים,בשר,טייק אווי', 0, 0, 

NULL, 'כן', 'כן', 'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(9, 'Black Bar ''n'' Burger', 'בלק','ילדי טהרן 6 מערב ראשל\"צ – מתחם G2, ראשון לציון', 2, 31.985023, 34.769998, '03-9414485', 'ארועים,בשר,טייק אווי', 0, 

0, NULL, 'כן', 'כן', 'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(10, 'Black Bar ''n'' Burger', 'בלק', 'שלומציון המלכה 18, ירושלים', 3, 31.778973, 35.222379, '02-6246767', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'כן', 'כן', 

'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(11, 'Black Bar ''n'' Burger', 'בלק', 'המדע 6, רחובות', 6, 31.913277, 34.803907, '08-9361230', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'כן', 'כן', 'כן', 'כן', 'לא', 

'לא', 'כן', 'כן', 'לא'),
(12, 'Black Bar ''n'' Burger', 'בלק','צומת לב המפרץ cinemall, חיפה', 4, 32.79289, 35.037221, '04-8422400', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'כן', 

'כן', 'כן', 'כן', 'לא', 'לא', 'כן', 'כן', 'לא'),
(13, 'ארומה שערי חדרה', 'Aroma', 'רח\' 4 האגודות 1, מתחם שערי חדרה', 7, 32.434547, 34.909261, '04-6221333', 'טייק אווי', 0, 0, NULL, 'כן', 'כן', 'לא', 'כן', 'כן', 'לא', 'לא', 'כן', 
...
(17, 'פאפאגאיו', 'Papagaio', 'מרכז עזריאלי 7 תל אביב', 1, 32.074451, 34.791855, '03-6092000', 'ארועים,בשר,טייק אווי', 0, 0, NULL, 'לא', 'כן', 'כן', 'כן', 'לא', 'כן', 'כן', 'לא', 
...
INSERT INTO `shopping` (`id`, `name`, `another_name`, `address`, `city_id`, `lat`, `lon`, `phone_number`, 

`category`, `grading`, `num_reviews`, `hours`, `link`, `invalid_access`, `parking`) VALUES
...
-- INSERT INTO `reviews` (`id`, `city_id`, `biz_id`, `biz_type`, `user_id`, `grading`, `title`, `review`, `added`) 
