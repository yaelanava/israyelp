				...
				while ($user = mysqli_fetch_assoc($result)){
					$html = "<div>
								...
								<div class=\"clearStyles photoBox\">
									<A href=\"./user_profile.php?user_id=".$user['id']."\" rel=\"nofollow\"><img style=\"WIDTH: 80px; HEIGHT: 80px\" alt=\"התמונה של " . $user['username'] ."\" src=\"".getUserPictureSrc($user['id'])."\"> </A>								
								</div>									
							</div>";
					echo $html;
				}										
		...
		<div id="leftColumn">
			...
			<?php 
				...
				<div id="freshListsModule">
					...
					<?php 
						$query_reviews = "SELECT * FROM `reviews` WHERE city_id=$city_id ORDER BY added DESC LIMIT 4"; //todo: same city or not?
...
<div id="pressLinks"><img src="./image/ads_full.png" width="950" height="84" usemap="#pressMap"  />
	<map name="pressMap">
		<area rel="nofollow" alt="חפש משתמש" href="./find_user.php" coords="10,6,232,79">
