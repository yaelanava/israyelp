...
<html>
<head>
	<title>ביקורות והמלצות גולשים - IsraYelp</title>
...
<div id="navContainer">
		<ul>
			...
			<LI class="header" id="messaging"><A id="Zmail" href="http://static.px.yelp.com/signup?return_url=%2Fmail" rel="nofollow">הודעות</A> |</LI>
			<LI class="header" id="talk"><A href="http://static.px.yelp.com/talk"> דיבור </A> |</LI>
			<LI class="header" id="events"><A href="http://static.px.yelp.com/events/sf"> אירועים </A>|</LI>
			...
			<LI class="header_login"> |<A id="Zprofile" href="http://static.px.yelp.com/signup?return_url=%2Fprofile" rel="nofollow"> חשבון </A> </LI>
...
<div id="external_search">
	<form method="get" action="/search" name="external_search"> 
		...
		<p>
			<label for="find_loc_ext">ליד <em>כתובת, עיר</em></label>
