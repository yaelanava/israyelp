...
<div id="navContainer">
		<ul>
			<LI class="header" id="aboutMe"><A   id="Zabout_me" href="./about.php" >עלינו</A> | </LI>
			...
			<LI class="header" id="invite"><A   id="Zinvite_friends" href="./invite_friend.php" >הזמן חברים</A></LI>
